...
//    _shadowView.frame = fram;
    ...
    UIImageView *imageView =[[UIImageView alloc] initWithFrame:CGRectMake(_shadowView.center.x - 15/2, -14, 15, 15)];
...
- (void)updateShadowAndContentViewFrame {
    ...
    frame.origin.x = _superV.center.x - _itemsWidth/2;
    frame.origin.y = viewFrame.origin.y + viewFrame.size.height + 15;
